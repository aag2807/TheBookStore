    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 5, 8, 9, 54, 30, 217, DateTimeKind.Local).AddTicks(4070), "admin@email.com", true, false, false, false, "admin", null, null, new DateTime(2024, 5, 8, 9, 54, 30, 217, DateTimeKind.Local).AddTicks(4070), "admin" },
                    { 2, new DateTime(2024, 5, 8, 9, 54, 30, 217, DateTimeKind.Local).AddTicks(4080), "user@email.com", false, false, false, false, "user", null, null, new DateTime(2024, 5, 8, 9, 54, 30, 217, DateTimeKind.Local).AddTicks(4080), "user" }
                });
